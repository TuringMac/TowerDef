...
namespace TowerDef
{
    class Ghost : Mob
    {
        public Ghost(List<Point> points, int wave) //передаю список вейпоинтов и номер волны
            : base(MobType.Ghost, wave)
        {
            this.points = points;
            x = points[0].X;
            y = points[0].Y;
        ...
        public override void draw()
        {
            ...
            GL.BindTexture(TextureTarget.Texture2D, Mob.texture[2]);
            
            GL.Begin(BeginMode.Quads);
 
            GL.Color4(1.0, 1.0, 1.0, 0.3);
